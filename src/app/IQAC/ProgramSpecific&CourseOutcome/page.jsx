...
export default function Page() {
  return (
    <div className="body bg-mapBg">
      <PageHeader tab={"IQAC"} nestedTab={"Program Specific & Course Outcome"}/>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-3xl p-8 text-center font-bold">Program Specific & Course Outcome</h1>
        <div className="flex flex-col sm:flex-row">
          <div className="pdf w-full sm:w-9/12 h-full mb-8 sm:mb-0">
            <Link href="https://pcacs.ac.in/wp-content/uploads/2021/12/PO-PSO-CO-of-Under-Graduate-2021-22.pdf" target='_blank' className='text-blue-500'>View Program Specific & Course Outcome</Link>
            <embed src="https://pcacs.ac.in/wp-content/uploads/2021/12/PO-PSO-CO-of-Under-Graduate-2021-22.pdf" type="application/pdf" width="100%" height="600px" />
          </div>
