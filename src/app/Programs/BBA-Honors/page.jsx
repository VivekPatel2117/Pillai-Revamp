...
export default function page() {
  ...
  return (
    <div>
      <PageHeader tab={"Programs"} nestedTab={"BBA Honors"} />
      <div className="content p-2">
        <div className="section1">
          <h1 className="text-2xl font-bold mt-4">About the course - {"BBA Honors"}</h1>
        ...
        <div className="section3 mt-10 mb-8">
          <h1 className="font-semibold text-lg">List of Subjects for the Three Year BBA Honors</h1>
          <hr className="w-9/12 border-t-2 border-gray-400 mb-4" />
          <div className="subjects bg-mapBg">
            <div className="fy">
              <h1 className="flex justify-center text-2xl font-bold" >FY BBA Honors</h1>
            ...
            <div className="sy">
              <h1 className="flex justify-center text-2xl font-bold mt-4" >SY BBA Honors</h1>
              <div className="subjects max-w-screen-md mx-auto">
                <table className="w-full">
                  <thead>
                    <tr>
            ...
            <div className="ty">
              <h1 className="flex justify-center text-2xl font-bold mt-4" >TY BBA Honors</h1>
              <div className="subjects max-w-screen-md mx-auto">
                <table className="w-full">
                  <thead>
                    <tr>
