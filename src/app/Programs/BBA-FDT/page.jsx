...
export default function page() {
  ...
  return (
    <div>
      <PageHeader tab={"Programs"} nestedTab={"BBA Fashion Design & Technology"} />
      <div className="content p-2">
        <div className="section1">
          <h1 className="text-2xl font-bold mt-4">About the course - {"BBA Fashion Design & Technology"}</h1>
        ...
        <div className="section3 mt-10 mb-8">
          <h1 className="font-semibold text-lg">List of Subjects for the Three Year BBA Fashion Design & Technology</h1>
          <hr className="w-9/12 border-t-2 border-gray-400 mb-4" />
          <div className="subjects bg-mapBg">
            <div className="fy">
              <h1 className="flex justify-center text-2xl font-bold" >FY BBA Fashion Design & Technology</h1>
            ...
            <div className="sy">
              <h1 className="flex justify-center text-2xl font-bold mt-4" >SY BBA Fashion Design & Technology</h1>
              <div className="subjects max-w-screen-md mx-auto">
                <table className="w-full">
                  <thead>
                    <tr>
            ...
            <div className="ty">
              <h1 className="flex justify-center text-2xl font-bold mt-4" >TY BBA Fashion Design & Technology</h1>
              <div className="subjects max-w-screen-md mx-auto">
                <table className="w-full">
                  <thead>
                    <tr>
